...
with open("C:\\Projet_TAL\\Corpus_brut\\phrase_aligne.txt", "r", encoding='utf-8') as input_file, \
        open("C:\\Projet_TAL\\Corpus_brut\\tokenisation.txt", "w", encoding='utf-8') as output_file:
    chinese_text = ""
    french_text = ""
